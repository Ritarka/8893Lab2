...
extern "C" void apatb_tiled_conv_hw(volatile void * __xlx_apatb_param_input_feature_map, volatile void * __xlx_apatb_param_layer_weights, volatile void * __xlx_apatb_param_layer_bias, volatile void * __xlx_apatb_param_output_feature_map) {
  ...
  for (int j = 0, e = 9408; j != e; ++j) {
    ...
    __xlx_layer_weights_layer_bias__tmp_vec.push_back(_xlx_tmp_sc);
  }
  ...
  for (int j = 0, e = 64; j != e; ++j) {
    sc_bv<16> _xlx_tmp_sc;
    _xlx_tmp_sc.range(7, 0) = ((char*)__xlx_apatb_param_layer_bias)[j*2+0];
    _xlx_tmp_sc.range(15, 8) = ((char*)__xlx_apatb_param_layer_bias)[j*2+1];
    __xlx_layer_weights_layer_bias__tmp_vec.push_back(_xlx_tmp_sc);
  }
...
// print __xlx_apatb_param_layer_bias
  ...
  for (int i = 0; i < __xlx_size_param_layer_bias; ++i) {
    ((char*)__xlx_apatb_param_layer_bias)[i*2+0] = __xlx_layer_bias_output_buffer[i].range(7, 0).to_uint();
    ((char*)__xlx_apatb_param_layer_bias)[i*2+1] = __xlx_layer_bias_output_buffer[i].range(15, 8).to_uint();
  }
}
