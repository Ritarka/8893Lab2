...
set name tiled_conv_mul_2ns_7ns_8_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}
...
set id 3
set name tiled_conv_ama_addmuladd_8ns_6ns_6ns_6ns_13_4_1
...
set ce_signed 0
set out_width 13
set arg_lists {i0 {8 0 +} i1 {6 0 +} s {8 0 +} i2 {6 0 +} m {13 1 +} i3 {6 0 +} p {13 0 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv_in_buf_V_address0 { O 13 vector } conv_in_buf_V_ce0 { O 1 bit } conv_in_buf_V_we0 { O 1 bit } conv_in_buf_V_d0 { O 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_p_mid2258 \
    op interface \
    ports { p_mid2258 { I 11 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_p_mid130 \
    op interface \
    ports { p_mid130 { I 1 vector } } \
} "
}
