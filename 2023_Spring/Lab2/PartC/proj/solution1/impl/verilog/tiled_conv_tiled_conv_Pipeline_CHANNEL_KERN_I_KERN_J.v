...
module tiled_conv_tiled_conv_Pipeline_CHANNEL_KERN_I_KERN_J (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [2:0] i_3_reg_596;
reg   [0:0] icmp_ln51_reg_601;
reg   [0:0] icmp_ln51_reg_601_pp0_iter1_reg;
reg   [0:0] icmp_ln51_reg_601_pp0_iter2_reg;
reg   [0:0] icmp_ln51_reg_601_pp0_iter3_reg;
reg   [0:0] icmp_ln51_reg_601_pp0_iter4_reg;
reg   [0:0] icmp_ln51_reg_601_pp0_iter5_reg;
reg   [0:0] icmp_ln51_reg_601_pp0_iter6_reg;
wire   [0:0] icmp_ln54_fu_236_p2;
reg   [0:0] icmp_ln54_reg_605;
wire   [1:0] select_ln51_1_fu_250_p3;
reg   [1:0] select_ln51_1_reg_610;
reg   [1:0] select_ln51_1_reg_610_pp0_iter1_reg;
reg   [1:0] select_ln51_1_reg_610_pp0_iter2_reg;
wire   [0:0] and_ln51_fu_270_p2;
reg   [0:0] and_ln51_reg_616;
wire   [2:0] add_ln54_fu_276_p2;
reg   [2:0] add_ln54_reg_621;
wire   [2:0] select_ln54_fu_288_p3;
reg   [2:0] select_ln54_reg_626;
reg   [2:0] select_ln54_reg_626_pp0_iter1_reg;
reg   [2:0] select_ln54_reg_626_pp0_iter2_reg;
reg   [2:0] select_ln54_reg_626_pp0_iter3_reg;
wire   [2:0] select_ln54_1_fu_296_p3;
reg   [2:0] select_ln54_1_reg_632;
reg   [2:0] select_ln54_1_reg_632_pp0_iter1_reg;
reg   [2:0] select_ln54_1_reg_632_pp0_iter2_reg;
wire   [5:0] add_ln58_fu_394_p2;
reg   [5:0] add_ln58_reg_637;
reg   [5:0] add_ln58_reg_637_pp0_iter2_reg;
...
wire   [63:0] zext_ln58_4_fu_475_p1;
reg   [15:0] lhs_fu_84;
wire   [15:0] zext_ln51_cast_fu_165_p1;
reg   [15:0] ap_sig_allocacmp_lhs_load_1;
wire    ap_loop_init;
reg   [2:0] j_fu_88;
wire   [2:0] add_ln57_fu_304_p2;
reg   [2:0] ap_sig_allocacmp_j_load;
reg   [2:0] i_fu_92;
reg   [2:0] ap_sig_allocacmp_i_3;
reg   [5:0] indvar_flatten118_fu_96;
wire   [5:0] select_ln54_3_fu_316_p3;
reg   [5:0] ap_sig_allocacmp_indvar_flatten118_load;
reg   [1:0] chan_fu_100;
reg   [1:0] ap_sig_allocacmp_chan_load;
reg   [7:0] indvar_flatten140_fu_104;
wire   [7:0] add_ln51_2_fu_215_p2;
reg   [7:0] ap_sig_allocacmp_indvar_flatten140_load;
wire    ap_block_pp0_stage0_01001;
wire   [1:0] add_ln51_fu_230_p2;
wire   [0:0] icmp_ln57_fu_264_p2;
wire   [0:0] xor_ln51_fu_258_p2;
wire   [2:0] select_ln51_fu_242_p3;
wire   [0:0] or_ln54_fu_282_p2;
wire   [5:0] add_ln54_1_fu_310_p2;
wire   [5:0] zext_ln54_fu_349_p1;
wire   [1:0] mul_ln58_fu_360_p0;
wire   [6:0] mul_ln58_fu_360_p1;
wire   [5:0] empty_fu_352_p2;
wire   [5:0] zext_ln54_1_fu_372_p1;
wire   [5:0] p_mid1116_fu_375_p2;
wire   [5:0] select_ln51_2_fu_366_p3;
wire   [5:0] select_ln54_2_fu_380_p3;
wire   [5:0] j_3_cast_fu_391_p1;
wire   [6:0] zext_ln58_fu_399_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln51_fu_209_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln51_fu_209_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln51_reg_601 == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln51_fu_209_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln51_reg_601 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln51_reg_601_pp0_iter6_reg == 1'd1))) begin
        lhs_out_ap_vld = 1'b1;
    end else begin
        lhs_out_ap_vld = 1'b0;
    end
...
assign add_ln1319_fu_402_p2 = ($signed(sub_ln1319_cast_reg_591) + $signed(zext_ln58_fu_399_p1));

assign add_ln51_2_fu_215_p2 = (ap_sig_allocacmp_indvar_flatten140_load + 8'd1);

assign add_ln51_fu_230_p2 = (ap_sig_allocacmp_chan_load + 2'd1);

assign add_ln54_1_fu_310_p2 = (ap_sig_allocacmp_indvar_flatten118_load + 6'd1);

assign add_ln54_fu_276_p2 = (select_ln51_fu_242_p3 + 3'd1);

assign add_ln57_fu_304_p2 = (select_ln54_fu_288_p3 + 3'd1);

assign add_ln58_fu_394_p2 = (j_3_cast_fu_391_p1 + select_ln45);

assign and_ln51_fu_270_p2 = (xor_ln51_fu_258_p2 & icmp_ln57_fu_264_p2);
...
assign conv_in_buf_V_address0 = zext_ln58_4_fu_475_p1;

assign conv_wt_buf_V_address0 = zext_ln1319_2_fu_470_p1;

assign empty_fu_352_p2 = (zext_ln54_fu_349_p1 + select_ln45_4);

assign grp_fu_516_p1 = grp_fu_516_p10;

assign grp_fu_516_p10 = select_ln54_2_fu_380_p3;

assign grp_fu_516_p2 = 13'd46;

assign grp_fu_516_p3 = grp_fu_516_p30;

assign grp_fu_516_p30 = add_ln58_reg_637_pp0_iter2_reg;

assign grp_fu_527_p2 = {{ap_sig_allocacmp_lhs_load_1}, {13'd0}};

assign icmp_ln51_fu_209_p2 = ((ap_sig_allocacmp_indvar_flatten140_load == 8'd147) ? 1'b1 : 1'b0);

assign icmp_ln54_fu_236_p2 = ((ap_sig_allocacmp_indvar_flatten118_load == 6'd49) ? 1'b1 : 1'b0);

assign icmp_ln57_fu_264_p2 = ((ap_sig_allocacmp_j_load == 3'd7) ? 1'b1 : 1'b0);

assign j_3_cast_fu_391_p1 = select_ln54_reg_626;

assign lhs_out = lhs_fu_84;

assign mul_ln58_fu_360_p0 = mul_ln58_fu_360_p00;

assign mul_ln58_fu_360_p00 = select_ln51_1_reg_610;

assign mul_ln58_fu_360_p1 = 8'd52;
...
assign or_ln54_fu_282_p2 = (icmp_ln54_fu_236_p2 | and_ln51_fu_270_p2);

assign p_mid1116_fu_375_p2 = (zext_ln54_1_fu_372_p1 + select_ln45_4);

assign p_shl_fu_449_p3 = {{trunc_ln1319_1_reg_647}, {3'd0}};

assign select_ln51_1_fu_250_p3 = ((icmp_ln54_fu_236_p2[0:0] == 1'b1) ? add_ln51_fu_230_p2 : ap_sig_allocacmp_chan_load);

assign select_ln51_2_fu_366_p3 = ((icmp_ln54_reg_605[0:0] == 1'b1) ? select_ln45_4 : empty_fu_352_p2);

assign select_ln51_fu_242_p3 = ((icmp_ln54_fu_236_p2[0:0] == 1'b1) ? 3'd0 : ap_sig_allocacmp_i_3);

assign select_ln54_1_fu_296_p3 = ((and_ln51_fu_270_p2[0:0] == 1'b1) ? add_ln54_fu_276_p2 : select_ln51_fu_242_p3);

assign select_ln54_2_fu_380_p3 = ((and_ln51_reg_616[0:0] == 1'b1) ? p_mid1116_fu_375_p2 : select_ln51_2_fu_366_p3);

assign select_ln54_3_fu_316_p3 = ((icmp_ln54_fu_236_p2[0:0] == 1'b1) ? 6'd1 : add_ln54_1_fu_310_p2);

assign select_ln54_fu_288_p3 = ((or_ln54_fu_282_p2[0:0] == 1'b1) ? 3'd0 : ap_sig_allocacmp_j_load);
...
assign xor_ln51_fu_258_p2 = (icmp_ln54_fu_236_p2 ^ 1'd1);

assign zext_ln1319_1_fu_456_p1 = select_ln54_reg_626_pp0_iter3_reg;

assign zext_ln1319_2_fu_470_p1 = newSecond_fu_464_p2;

assign zext_ln1319_fu_423_p1 = select_ln54_1_reg_632_pp0_iter2_reg;

assign zext_ln51_cast_fu_165_p1 = zext_ln51;

assign zext_ln54_1_fu_372_p1 = add_ln54_reg_621;

assign zext_ln54_fu_349_p1 = i_3_reg_596;

assign zext_ln58_4_fu_475_p1 = grp_fu_516_p4;

assign zext_ln58_fu_399_p1 = select_ln51_1_reg_610_pp0_iter2_reg;

endmodule //tiled_conv_tiled_conv_Pipeline_CHANNEL_KERN_I_KERN_J
