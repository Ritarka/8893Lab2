...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv_in_buf_V_address0 { O 8 vector } conv_in_buf_V_ce0 { O 1 bit } conv_in_buf_V_we0 { O 1 bit } conv_in_buf_V_d0 { O 736 vector } conv_in_buf_V_q0 { I 736 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_p_mid1238 \
    op interface \
    ports { p_mid1238 { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { select_ln24_21 { I 11 vector } } \
} "
}
