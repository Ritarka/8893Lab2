...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv_wt_buf_V_address0 { O 10 vector } conv_wt_buf_V_ce0 { O 1 bit } conv_wt_buf_V_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv_in_buf_V_address0 { O 13 vector } conv_in_buf_V_ce0 { O 1 bit } conv_in_buf_V_q0 { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln40_4 \
    op interface \
    ports { select_ln40_4 { I 6 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln40 \
    op interface \
    ports { select_ln40 { I 6 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_lhs_out \
    op interface \
    ports { lhs_out { O 16 vector } lhs_out_ap_vld { O 1 bit } } \
} "
}
