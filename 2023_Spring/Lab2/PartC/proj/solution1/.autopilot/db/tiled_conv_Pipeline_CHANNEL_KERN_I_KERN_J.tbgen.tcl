set moduleName tiled_conv_Pipeline_CHANNEL_KERN_I_KERN_J
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {tiled_conv_Pipeline_CHANNEL_KERN_I_KERN_J}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln51 int 15 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln51", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln51 sc_in sc_lv 15 signal 0 } 
	{ select_ln45_4 sc_in sc_lv 6 signal 1 } 
	...
	{ select_ln45 sc_in sc_lv 6 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln51", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln51", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		"CDFG" : "tiled_conv_Pipeline_CHANNEL_KERN_I_KERN_J",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	tiled_conv_Pipeline_CHANNEL_KERN_I_KERN_J {
...
set Spec2ImplPortList { 
	zext_ln51 { ap_none {  { zext_ln51 in_data 0 15 } } }
