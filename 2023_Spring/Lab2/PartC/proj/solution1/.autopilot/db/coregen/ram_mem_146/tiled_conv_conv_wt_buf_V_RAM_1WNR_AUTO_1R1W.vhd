...
entity tiled_conv_conv_wt_buf_V_RAM_1WNR_AUTO_1R1W is 
    generic(
...
architecture rtl of tiled_conv_conv_wt_buf_V_RAM_1WNR_AUTO_1R1W is 
    ...
    if (clk'event and clk = '1') then
        if (ce0 = '1') then 
            ...
            for i in 0 to NUM_COL - 1 loop
                if (we0(i) = '1') then
                    ram0(CONV_INTEGER(address0_tmp))((i + 1) * COL_WIDTH - 1 downto i * COL_WIDTH) := d0((i + 1) * COL_WIDTH - 1 downto i * COL_WIDTH); 
                end if;
            end loop;
        end if;
    end if;
...
begin 
    if (clk'event and clk = '1') then
        ...
        if (ce0 = '1') then 
            for i in 0 to NUM_COL - 1 loop
                if (we0(i) = '1') then
                    ram3(CONV_INTEGER(address0))((i + 1) * COL_WIDTH - 1 downto i * COL_WIDTH) := d0((i + 1) * COL_WIDTH - 1 downto i * COL_WIDTH); 
                end if;
            end loop;
        end if;
    end if;
...
begin 
    if (clk'event and clk = '1') then
        ...
        if (ce0 = '1') then 
            for i in 0 to NUM_COL - 1 loop
                if (we0(i) = '1') then
                    ram4(CONV_INTEGER(address0))((i + 1) * COL_WIDTH - 1 downto i * COL_WIDTH) := d0((i + 1) * COL_WIDTH - 1 downto i * COL_WIDTH); 
                end if;
            end loop;
        end if;
    end if;
...
begin 
    if (clk'event and clk = '1') then
        ...
        if (ce0 = '1') then 
            for i in 0 to NUM_COL - 1 loop
                if (we0(i) = '1') then
                    ram5(CONV_INTEGER(address0))((i + 1) * COL_WIDTH - 1 downto i * COL_WIDTH) := d0((i + 1) * COL_WIDTH - 1 downto i * COL_WIDTH); 
                end if;
            end loop;
        end if;
    end if;
