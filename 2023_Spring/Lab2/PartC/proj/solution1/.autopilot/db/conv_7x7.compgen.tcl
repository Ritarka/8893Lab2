...
set id 37
set name tiled_conv_mac_muladd_3ns_6ns_5ns_8_1_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 8
set exp i0*i1+i2
set arg_lists {i0 {3 0 +} i1 {6 0 +} m {8 0 +} i2 {5 0 +} p {8 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Y_buf \
    op interface \
    ports { Y_buf_address0 { O 11 vector } Y_buf_ce0 { O 1 bit } Y_buf_we0 { O 1 bit } Y_buf_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename X_buf \
    op interface \
    ports { X_buf_address0 { O 13 vector } X_buf_ce0 { O 1 bit } X_buf_q0 { I 16 vector } X_buf_address1 { O 13 vector } X_buf_ce1 { O 1 bit } X_buf_q1 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename W_buf \
    op interface \
    ports { W_buf_address0 { O 10 vector } W_buf_ce0 { O 1 bit } W_buf_q0 { I 16 vector } W_buf_address1 { O 10 vector } W_buf_ce1 { O 1 bit } W_buf_q1 { I 16 vector } } \
} "
} else {
