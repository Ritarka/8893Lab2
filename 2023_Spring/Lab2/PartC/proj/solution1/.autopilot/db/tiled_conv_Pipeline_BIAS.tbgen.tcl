...
set C_modelType { void 0 }
set C_modelArgList {
	{ conv_bias_buf_V_7 int 16 regular  }
	{ conv_bias_buf_V_6 int 16 regular  }
	{ conv_bias_buf_V_5 int 16 regular  }
	{ conv_bias_buf_V_4 int 16 regular  }
	{ wt int 16 regular {axi_master 0}  }
	{ sext_ln91 int 63 regular  }
	{ conv_bias_buf_V_11_out int 16 regular {pointer 1}  }
	{ conv_bias_buf_V_10_out int 16 regular {pointer 1}  }
	{ conv_bias_buf_V_9_out int 16 regular {pointer 1}  }
	{ conv_bias_buf_V_8_out int 16 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "conv_bias_buf_V_7", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "conv_bias_buf_V_6", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "conv_bias_buf_V_5", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "conv_bias_buf_V_4", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "wt", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "layer_weights","offset": { "type": "dynamic","port_name": "layer_weights","bundle": "control"},"direction": "READONLY"},{"cName": "layer_bias","offset": { "type": "dynamic","port_name": "layer_bias","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln91", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "conv_bias_buf_V_11_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "conv_bias_buf_V_10_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "conv_bias_buf_V_9_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "conv_bias_buf_V_8_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
# RTL Port declarations: 
set portNum 65
set portList { 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	...
	{ m_axi_wt_BID sc_in sc_lv 1 signal 4 } 
	{ m_axi_wt_BUSER sc_in sc_lv 1 signal 4 } 
	{ conv_bias_buf_V_7 sc_in sc_lv 16 signal 0 } 
	{ conv_bias_buf_V_6 sc_in sc_lv 16 signal 1 } 
	{ conv_bias_buf_V_5 sc_in sc_lv 16 signal 2 } 
	{ conv_bias_buf_V_4 sc_in sc_lv 16 signal 3 } 
	{ sext_ln91 sc_in sc_lv 63 signal 5 } 
	{ conv_bias_buf_V_11_out sc_out sc_lv 16 signal 6 } 
	{ conv_bias_buf_V_11_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ conv_bias_buf_V_10_out sc_out sc_lv 16 signal 7 } 
	{ conv_bias_buf_V_10_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ conv_bias_buf_V_9_out sc_out sc_lv 16 signal 8 } 
	{ conv_bias_buf_V_9_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ conv_bias_buf_V_8_out sc_out sc_lv 16 signal 9 } 
	{ conv_bias_buf_V_8_out_ap_vld sc_out sc_logic 1 outvld 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	{ "name": "ap_rst", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "reset", "bundle":{"name": "ap_rst", "role": "default" }} , 
 	...
 	{ "name": "m_axi_wt_BID", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "wt", "role": "BID" }} , 
 	{ "name": "m_axi_wt_BUSER", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "wt", "role": "BUSER" }} , 
 	{ "name": "conv_bias_buf_V_7", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv_bias_buf_V_7", "role": "default" }} , 
 	{ "name": "conv_bias_buf_V_6", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv_bias_buf_V_6", "role": "default" }} , 
 	{ "name": "conv_bias_buf_V_5", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv_bias_buf_V_5", "role": "default" }} , 
 	{ "name": "conv_bias_buf_V_4", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv_bias_buf_V_4", "role": "default" }} , 
 	{ "name": "sext_ln91", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln91", "role": "default" }} , 
 	{ "name": "conv_bias_buf_V_11_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv_bias_buf_V_11_out", "role": "default" }} , 
 	{ "name": "conv_bias_buf_V_11_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "conv_bias_buf_V_11_out", "role": "ap_vld" }} , 
 	{ "name": "conv_bias_buf_V_10_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv_bias_buf_V_10_out", "role": "default" }} , 
 	{ "name": "conv_bias_buf_V_10_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "conv_bias_buf_V_10_out", "role": "ap_vld" }} , 
 	{ "name": "conv_bias_buf_V_9_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv_bias_buf_V_9_out", "role": "default" }} , 
 	{ "name": "conv_bias_buf_V_9_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "conv_bias_buf_V_9_out", "role": "ap_vld" }} , 
 	{ "name": "conv_bias_buf_V_8_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv_bias_buf_V_8_out", "role": "default" }} , 
 	{ "name": "conv_bias_buf_V_8_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "conv_bias_buf_V_8_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "conv_bias_buf_V_7", "Type" : "None", "Direction" : "I"},
			{"Name" : "conv_bias_buf_V_6", "Type" : "None", "Direction" : "I"},
			{"Name" : "conv_bias_buf_V_5", "Type" : "None", "Direction" : "I"},
			{"Name" : "conv_bias_buf_V_4", "Type" : "None", "Direction" : "I"},
			{"Name" : "wt", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "wt_blk_n_R", "Type" : "RtlSignal"}]},
			{"Name" : "sext_ln91", "Type" : "None", "Direction" : "I"},
			{"Name" : "conv_bias_buf_V_11_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "conv_bias_buf_V_10_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "conv_bias_buf_V_9_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "conv_bias_buf_V_8_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "BIAS", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter2", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	tiled_conv_Pipeline_BIAS {
		conv_bias_buf_V_7 {Type I LastRead 0 FirstWrite -1}
		conv_bias_buf_V_6 {Type I LastRead 0 FirstWrite -1}
		conv_bias_buf_V_5 {Type I LastRead 0 FirstWrite -1}
		conv_bias_buf_V_4 {Type I LastRead 0 FirstWrite -1}
		wt {Type I LastRead 1 FirstWrite -1}
		sext_ln91 {Type I LastRead 0 FirstWrite -1}
		conv_bias_buf_V_11_out {Type O LastRead -1 FirstWrite 1}
		conv_bias_buf_V_10_out {Type O LastRead -1 FirstWrite 1}
		conv_bias_buf_V_9_out {Type O LastRead -1 FirstWrite 1}
		conv_bias_buf_V_8_out {Type O LastRead -1 FirstWrite 1}}}
...
set Spec2ImplPortList { 
	conv_bias_buf_V_7 { ap_none {  { conv_bias_buf_V_7 in_data 0 16 } } }
	conv_bias_buf_V_6 { ap_none {  { conv_bias_buf_V_6 in_data 0 16 } } }
	conv_bias_buf_V_5 { ap_none {  { conv_bias_buf_V_5 in_data 0 16 } } }
	conv_bias_buf_V_4 { ap_none {  { conv_bias_buf_V_4 in_data 0 16 } } }
	 { m_axi {  { m_axi_wt_AWVALID VALID 1 1 }  { m_axi_wt_AWREADY READY 0 1 }  { m_axi_wt_AWADDR ADDR 1 64 }  { m_axi_wt_AWID ID 1 1 }  { m_axi_wt_AWLEN SIZE 1 32 }  { m_axi_wt_AWSIZE BURST 1 3 }  { m_axi_wt_AWBURST LOCK 1 2 }  { m_axi_wt_AWLOCK CACHE 1 2 }  { m_axi_wt_AWCACHE PROT 1 4 }  { m_axi_wt_AWPROT QOS 1 3 }  { m_axi_wt_AWQOS REGION 1 4 }  { m_axi_wt_AWREGION USER 1 4 }  { m_axi_wt_AWUSER DATA 1 1 }  { m_axi_wt_WVALID VALID 1 1 }  { m_axi_wt_WREADY READY 0 1 }  { m_axi_wt_WDATA FIFONUM 1 16 }  { m_axi_wt_WSTRB STRB 1 2 }  { m_axi_wt_WLAST LAST 1 1 }  { m_axi_wt_WID ID 1 1 }  { m_axi_wt_WUSER DATA 1 1 }  { m_axi_wt_ARVALID VALID 1 1 }  { m_axi_wt_ARREADY READY 0 1 }  { m_axi_wt_ARADDR ADDR 1 64 }  { m_axi_wt_ARID ID 1 1 }  { m_axi_wt_ARLEN SIZE 1 32 }  { m_axi_wt_ARSIZE BURST 1 3 }  { m_axi_wt_ARBURST LOCK 1 2 }  { m_axi_wt_ARLOCK CACHE 1 2 }  { m_axi_wt_ARCACHE PROT 1 4 }  { m_axi_wt_ARPROT QOS 1 3 }  { m_axi_wt_ARQOS REGION 1 4 }  { m_axi_wt_ARREGION USER 1 4 }  { m_axi_wt_ARUSER DATA 1 1 }  { m_axi_wt_RVALID VALID 0 1 }  { m_axi_wt_RREADY READY 1 1 }  { m_axi_wt_RDATA FIFONUM 0 16 }  { m_axi_wt_RLAST LAST 0 1 }  { m_axi_wt_RID ID 0 1 }  { m_axi_wt_RFIFONUM LEN 0 10 }  { m_axi_wt_RUSER DATA 0 1 }  { m_axi_wt_RRESP RESP 0 2 }  { m_axi_wt_BVALID VALID 0 1 }  { m_axi_wt_BREADY READY 1 1 }  { m_axi_wt_BRESP RESP 0 2 }  { m_axi_wt_BID ID 0 1 }  { m_axi_wt_BUSER DATA 0 1 } } }
	sext_ln91 { ap_none {  { sext_ln91 in_data 0 63 } } }
	conv_bias_buf_V_11_out { ap_vld {  { conv_bias_buf_V_11_out out_data 1 16 }  { conv_bias_buf_V_11_out_ap_vld out_vld 1 1 } } }
	conv_bias_buf_V_10_out { ap_vld {  { conv_bias_buf_V_10_out out_data 1 16 }  { conv_bias_buf_V_10_out_ap_vld out_vld 1 1 } } }
	conv_bias_buf_V_9_out { ap_vld {  { conv_bias_buf_V_9_out out_data 1 16 }  { conv_bias_buf_V_9_out_ap_vld out_vld 1 1 } } }
	conv_bias_buf_V_8_out { ap_vld {  { conv_bias_buf_V_8_out out_data 1 16 }  { conv_bias_buf_V_8_out_ap_vld out_vld 1 1 } } }
}
set moduleName tiled_conv_Pipeline_BIAS
set isTopModule 0
set isCombinational 0
