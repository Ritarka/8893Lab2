...
set id 47
set name tiled_conv_mul_mul_6ns_19ns_25_4_1
...
set id 48
set name tiled_conv_mac_muladd_3ns_5ns_5ns_8_4_1
...
set ce_signed 0
set out_width 8
set arg_lists {i0 {3 0 +} i1 {5 0 +} m {8 1 +} i2 {5 0 +} p {8 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp48} LATENCY 3 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv_out_buf_V_address0 { O 11 vector } conv_out_buf_V_ce0 { O 1 bit } conv_out_buf_V_q0 { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { select_ln24_4 { I 11 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln130_5 \
    op interface \
    ports { zext_ln130_5 { I 19 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { select_ln24_1 { I 7 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { select_ln24_2 { I 9 vector } } \
} "
}
