set moduleName conv_7x7_Pipeline_CHANNEL_KERN_I5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {conv_7x7_Pipeline_CHANNEL_KERN_I5}
...
set C_modelArgList {
	...
	{ val_V_4_out int 16 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sub_ln1319", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "val_V_4_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ val_V_4_out sc_out sc_lv 16 signal 4 } 
	{ val_V_4_out_ap_vld sc_out sc_logic 1 outvld 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "val_V_4_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "val_V_4_out", "role": "default" }} , 
 	{ "name": "val_V_4_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "val_V_4_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
		"CDFG" : "conv_7x7_Pipeline_CHANNEL_KERN_I5",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "val_V_4_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	conv_7x7_Pipeline_CHANNEL_KERN_I5 {
		...
		val_V_4_out {Type O LastRead -1 FirstWrite 8}}}
...
set Spec2ImplPortList { 
	...
	val_V_4_out { ap_vld {  { val_V_4_out out_data 1 16 }  { val_V_4_out_ap_vld out_vld 1 1 } } }
}
set moduleName conv_7x7_Pipeline_CHANNEL_KERN_I5
set isTopModule 0
set isCombinational 0
