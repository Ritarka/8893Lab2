...
always @ (*) begin
    ap_condition_317 = ((ap_enable_reg_pp0_iter6 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001));
end
...
assign empty_54_fu_400_p2 = ((empty_fu_395_p2 > 11'd735) ? 1'b1 : 1'b0);
...
assign select_ln37_2_fu_415_p3 = ((icmp_ln40_reg_840[0:0] == 1'b1) ? p_mid132 : empty_54_fu_400_p2);
...
assign shl_ln4_fu_668_p3 = {{select_ln40_reg_872_pp0_iter5_reg}, {4'd0}};
...
assign zext_ln50_fu_712_p1 = shl_ln4_fu_668_p3;

assign zext_ln52_1_fu_696_p1 = fm_addr_read_reg_921;

assign zext_ln52_fu_675_p1 = shl_ln4_fu_668_p3;
